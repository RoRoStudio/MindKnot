...
export default function HomeScreen() {
    ...
    const recentEntries = [
        ...
        ...actions.map(a => ({ id: a.id, type: 'action', title: a.title, date: formatRelativeDate(a.createdAt), ...iconMap.action })),
        ...paths.map(p => ({ id: p.id, type: 'path', title: p.title, date: formatRelativeDate(p.createdAt), ...iconMap.path })),
        ...loops.map(l => ({ id: l.id, type: 'loop', title: l.title, date: formatRelativeDate(l.createdAt), ...iconMap.loop })),
    ]
